...
const signaturePath = [
  // A
  [0.2, 0.8], [0.225, 0.3], [0.25, 0.8],
  [0.215, 0.6], [0.26, 0.6],
  // r
  [0.275, 0.6], [0.275, 0.5], [0.3, 0.5], [0.3, 0.6],
  // p
  [0.32, 0.4], [0.32, 0.8], [0.34, 0.6], [0.36, 0.7], [0.34, 0.8],
  // i
  [0.375, 0.5], [0.375, 0.6],
  [0.375, 0.4], [0.375, 0.45],
  // t
  [0.39, 0.4], [0.39, 0.6],
  [0.37, 0.5], [0.41, 0.5],
  // (space)
  // S
  [0.44, 0.5], [0.435, 0.55], [0.44, 0.6], [0.435, 0.65],
  // i
  [0.455, 0.5], [0.455, 0.6],
  [0.455, 0.4], [0.455, 0.45],
  // n
  [0.47, 0.6], [0.47, 0.5], [0.49, 0.6], [0.49, 0.5],
  // g
  [0.505, 0.5], [0.505, 0.6], [0.52, 0.6], [0.52, 0.7], [0.505, 0.75],
  // h
  [0.535, 0.6], [0.535, 0.5], [0.555, 0.5], [0.555, 0.6],
  // a
  [0.57, 0.6], [0.58, 0.5], [0.59, 0.6], [0.58, 0.7], [0.57, 0.6],
  // l
  [0.6, 0.4], [0.6, 0.6]
];
