...
const signaturePath = [
  ...
  // i
  [0.6, 0.5], [0.6, 0.6],
  [0.6, 0.35], [0.6, 0.4], // dot
  // t
  [0.65, 0.4], [0.65, 0.6],
  [0.6, 0.5], [0.7, 0.5],
  // S (smooth curve)
  [0.75, 0.6], [0.78, 0.55], [0.75, 0.5], [0.78, 0.45], [0.75, 0.4],
  // i
  [0.82, 0.5], [0.82, 0.6],
  [0.82, 0.35], [0.82, 0.4], // dot
  // n
  [0.86, 0.6], [0.86, 0.5], [0.9, 0.5], [0.9, 0.6],
  // g (loop)
  [0.95, 0.5], [0.95, 0.65], [0.9, 0.65], [0.9, 0.55],
  [0.95, 0.65], [0.95, 0.8], [0.96, 0.85],
  // h (looped top)
  [1.0, 0.6], [1.0, 0.4], [1.05, 0.4], [1.05, 0.5], [1.0, 0.5],
  // a (connected from h)
  [1.08, 0.6], [1.13, 0.5], [1.08, 0.5], [1.08, 0.6],
  // l
  [1.16, 0.4], [1.16, 0.6]
];
