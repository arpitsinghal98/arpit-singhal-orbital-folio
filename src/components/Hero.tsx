...
const signaturePath = [
  // A
  [0.2, 0.8], [0.23, 0.3], [0.26, 0.8],
  [0.215, 0.6], [0.245, 0.6],
  // r
  [0.27, 0.6], [0.27, 0.5], [0.295, 0.5], [0.295, 0.6],
  // p
  [0.315, 0.4], [0.315, 0.8], [0.34, 0.6], [0.365, 0.7], [0.34, 0.8],
  // i
  [0.385, 0.5], [0.385, 0.6],
  [0.385, 0.4], [0.385, 0.45],
  // t
  [0.41, 0.4], [0.41, 0.6],
  [0.39, 0.5], [0.43, 0.5],

  // S
  [0.455, 0.5], [0.435, 0.55], [0.455, 0.6], [0.435, 0.65],
  // i
  [0.47, 0.5], [0.47, 0.6],
  [0.47, 0.4], [0.47, 0.45],
  // n
  ...
  // g
  [0.53, 0.5], [0.53, 0.65], [0.55, 0.7], [0.53, 0.75],
  [0.53, 0.8], [0.55, 0.85],
  // h
  [0.57, 0.4], [0.57, 0.8], [0.59, 0.6], [0.61, 0.6],
  // a
  [0.63, 0.6], [0.635, 0.5], [0.655, 0.5], [0.655, 0.6], [0.635, 0.6],
  // l
  [0.67, 0.4], [0.67, 0.8],
];
